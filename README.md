...
| [使用RxJava.Observable取代AsyncTask和AsyncTaskLoader](others/使用RxJava.Observable取代AsyncTask和AsyncTaskLoader)  | [ZhaoKaiQiang](https://github.com/ZhaoKaiQiang) |  [stablekernel.com](http://stablekernel.com/)  |
| [通过进度条上传拍下的照片、视频到服务器](others/通过进度条上传拍下的照片、视频到服务器)  | [chaossss](https://github.com/chaossss) |  [http://www.androidhive.info](http://www.androidhive.info/)  |
