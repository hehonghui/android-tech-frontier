    原文 [Android M &quot;App Links&quot; implementation in depth](https://chris.orr.me.uk/android-app-linking-how-it-works/)&nbsp;
...
### 
    ...
    创建完文件之后，你需要上传它同时保证它可以使用这个URL访问[http://example.com/.well-known/statements.json。](http://example.com/.well-known/statements.json.)
